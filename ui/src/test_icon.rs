...
mod tests {
    ...
    fn test_i18n_translations() {
        ...
        assert_eq!(i18n_en.translate(IconName::Dashboard.default_translation_key()), "Dashboard");
        assert_eq!(i18n_es.translate(IconName::Dashboard.default_translation_key()), "Panel");
    }
